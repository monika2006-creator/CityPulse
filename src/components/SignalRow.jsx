...
export const SEVERITY_STYLES = {
  normal: { text: "text-normal-ink", chip: "bg-normal/10", label: "NORMAL" },
  attention: { text: "text-attention-ink", chip: "bg-attention/10", label: "ATTENTION" },
  critical: { text: "text-critical-ink", chip: "bg-critical/10", label: "CRITICAL" },
};
...
export default function SignalRow({ signal }) {
  ...
  return (
    <div className="flex items-center gap-3 rounded-lg border border-border bg-inset px-3 py-2.5 transition-colors duration-200 hover:border-line">
